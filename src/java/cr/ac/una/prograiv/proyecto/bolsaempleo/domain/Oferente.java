...
public class Oferente  implements java.io.Serializable {
    ...
    public Oferente(int pkCedula, Localizacion localizacion, Usuario usuario, String nombre, String apellido1, String apellido2, String nacionalidad, String correo, String residencia, Integer ultimoUsuario, Date fechaCambios, List<Subcategoria> subcategorias, List<Puesto> puestos) {
       this.pkCedula = pkCedula;
       this.localizacion = localizacion;
